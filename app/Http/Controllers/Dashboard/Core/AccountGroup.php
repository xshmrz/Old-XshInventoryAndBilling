    ...
    class AccountGroup extends Controller {
        ...
        public function store(Request $request) {
            ...
            if ($validator->fails()) {
                ...
                if ($request->has("redirect")) {
                    ...
                    return redirect()->route("dashboard.account-group.edit", $accountGroup->id);
                }
            }
        }
            ...
            if ($validator->fails()) {
               ...
               return redirect()->back()->withInput();
                ...
                if ($request->has("redirect")) {
                    ...
                    return redirect()->route("dashboard.account-group.edit", $id);
                }
            }
        }
        public function destroy($id) {
            ...
            if (\request()->has("redirect")) {
                ...
                return redirect()->route("dashboard.account-group.index")->withInput();
            }
        }
    }
