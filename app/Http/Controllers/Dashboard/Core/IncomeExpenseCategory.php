    ...
    class IncomeExpenseCategory extends Controller {
        ...
        public function store(Request $request) {
            ...
            if ($validator->fails()) {
                ...
                if ($request->has("redirect")) {
                    ...
                    return redirect()->route("dashboard.income-expense-category.edit", $incomeExpenseCategory->id);
                }
            }
        }
            ...
            if ($validator->fails()) {
               ...
               return redirect()->back()->withInput();
                ...
                if ($request->has("redirect")) {
                    ...
                    return redirect()->route("dashboard.income-expense-category.edit", $id);
                }
            }
        }
        public function destroy($id) {
            ...
            if (\request()->has("redirect")) {
                ...
                return redirect()->route("dashboard.income-expense-category.index")->withInput();
            }
        }
    }
