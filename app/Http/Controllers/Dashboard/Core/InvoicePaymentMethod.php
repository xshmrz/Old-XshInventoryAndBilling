    ...
    class InvoicePaymentMethod extends Controller {
        ...
        public function store(Request $request) {
            ...
            if ($validator->fails()) {
                ...
                if ($request->has("redirect")) {
                    ...
                    return redirect()->route("dashboard.invoice-payment-method.edit", $invoicePaymentMethod->id);
                }
            }
        }
            ...
            if ($validator->fails()) {
               ...
               return redirect()->back()->withInput();
                ...
                if ($request->has("redirect")) {
                    ...
                    return redirect()->route("dashboard.invoice-payment-method.edit", $id);
                }
            }
        }
        public function destroy($id) {
            ...
            if (\request()->has("redirect")) {
                ...
                return redirect()->route("dashboard.invoice-payment-method.index")->withInput();
            }
        }
    }
