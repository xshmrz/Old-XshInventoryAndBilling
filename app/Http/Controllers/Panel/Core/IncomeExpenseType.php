    ...
    class IncomeExpenseType extends Controller {
        ...
        public function store(Request $request) {
            ...
            if ($validator->fails()) {
                ...
                if ($request->has("redirect")) {
                    ...
                    return redirect()->route("panel.income-expense-type.edit", $incomeExpenseType->id);
                }
            }
        }
            ...
            if ($validator->fails()) {
               ...
               return redirect()->back()->withInput();
                ...
                if ($request->has("redirect")) {
                    ...
                    return redirect()->route("panel.income-expense-type.edit", $id);
                }
            }
        }
        public function destroy($id) {
            ...
            if (\request()->has("redirect")) {
                ...
                return redirect()->route("panel.income-expense-type.index")->withInput();
            }
        }
    }
