    ...
    class InvoiceDetail extends Controller {
        ...
        public function store(Request $request) {
            ...
            if ($validator->fails()) {
                ...
                if ($request->has("redirect")) {
                    ...
                    return redirect()->route("site.invoice-detail.edit", $invoiceDetail->id);
                }
            }
        }
            ...
            if ($validator->fails()) {
               ...
               return redirect()->back()->withInput();
                ...
                if ($request->has("redirect")) {
                    ...
                    return redirect()->route("site.invoice-detail.edit", $id);
                }
            }
        }
        public function destroy($id) {
            ...
            if (\request()->has("redirect")) {
                ...
                return redirect()->route("site.invoice-detail.index")->withInput();
            }
        }
    }
